...
If you just want to run the app without installing Python, you can find the pre-built desktop executable:
1. Go to the `dist/` folder in this repository.
2. Inside the `run_desktop` folder, find and double-click `run_desktop.exe`.
3. The app will launch in your browser automatically!

*Note: Windows Defender might flag this file as an "Unknown Publisher" since it was built locally. You can safely click "More info" -> "Run anyway".*
